...
v[94]=v[104]+500e0*v[46]*v[47]-0.15000000000000013e-2*v[60];
...
v[39]=(v[12]*v[12]);
v[92]=0.126e0*v[39];
dPsiDu[0]=v[103]+v[46]*(500e0*v[39]+0.63e-1*v[51])+v[60]*(0.315e-1*(v[11]-v[13])+v[65])
 -v[48]*v[96];
dPsiDu[1]=v[103]+v[47]*(500e0*v[38]+0.63e-1*v[56])+v[60]*(0.315e-1*(v[12]-v[14])+v[65])
 -v[53]*v[92];
...
dPsiDu2[0][0]=v[105]+1000e0*v[39]-0.252e0*v[46]*v[48]+0.126e0*v[51]+v[96];
dPsiDu2[0][1]=v[94];
dPsiDu2[1][0]=v[94];
dPsiDu2[1][1]=v[105]+1000e0*v[38]-0.252e0*v[47]*v[53]+0.126e0*v[56]+v[92];
