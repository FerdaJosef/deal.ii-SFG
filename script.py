...
{"""
    ...
    # --------------------------------------------------
    # 3.5 Remove "int i01;" declaration
    # --------------------------------------------------
    # Odstraní řádek s int i01; i případné varianty s mezerami
    content = re.sub(r'^\s*int\s+i01\s*;\s*$', '', content, flags=re.MULTILINE)
...
"""
    ...
    output_file = os.path.join(directory, "equation.h")
