...
*           Co. J. Korelc  2020           28 Jul 26 22:36:55 *
**************************************************************
...
v[115]=-0.1199999999999999e-1*(v[45]*v[45]);
v[163]=v[115]+2e0*v[116]-0.1199999999999999e-1*v[65];
v[164]=v[163]-0.29999999999999977e-2*v[81];
v[155]=v[115]*v[64]-0.5999999999999995e-2*v[58]*v[65];
...
dPsiDu2[2][2]=v[120]+v[132]+v[133]+v[142]-0.264e0*v[61]*v[73]+0.132e0*v[74];
