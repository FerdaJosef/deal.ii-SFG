...
*           Co. J. Korelc  2020           28 May 26 19:33:59 *
**************************************************************
...
Total size of C code            : 4522 bytes */
#include "sms.h"

/******************* S U B R O U T I N E *********************/
void RandomEquation(double v[242],double U[3],double U0[3],double 
...
v[55]=(v[54]*v[54]);
v[49]=-2e0*v[37];
v[97]=-0.1199999999999999e-1*v[49]*v[54];
v[66]=3e0+v[49];
v[95]=0.8e-1*v[49]+0.4e-1*v[66];
v[45]=(v[37]*v[37]);
v[96]=-0.1199999999999999e-1*v[45];
v[126]=-0.1199999999999999e-1*v[55]+v[96]+2e0*v[97];
v[124]=v[126]-0.29999999999999977e-2*v[68]+v[95];
v[113]=v[124]+v[125]*v[50];
v[107]=v[124]+v[125]*v[52];
v[106]=v[124]+100e0*v[50]*v[52];
v[127]=0.4e-1*v[45]+v[49]*(-0.5999999999999995e-2*v[55]+0.2e-1*v[66])+v[54]*v[96];
v[73]=0.29999999999999977e-2*(-1e0+v[16]+v[17]+v[18]+v[37]);
v[82]=-0.29999999999999977e-2*(v[11]+v[7]+v[9]);
v[84]=-0.29999999999999977e-2*(v[10]+v[12]+v[8]);
v[41]=(v[13]*v[13]);
v[130]=100e0*v[41];
v[115]=0.132e0*v[41];
v[42]=(v[14]*v[14]);
...
v[117]=200e0*v[43];
v[104]=0.132e0*v[43];
dPsiDu[0]=v[127]-v[115]*v[53]+v[50]*(v[128]+v[129]+0.6599999999999999e-1*v[56])+v[68]*
 (0.32999999999999996e-1*(v[13]-v[16])+v[73]);
dPsiDu[1]=v[127]-v[111]*v[58]+v[51]*(v[129]+v[130]+0.6599999999999999e-1*v[61])+v[68]*
 (0.32999999999999996e-1*(v[14]-v[17])+v[73]);
dPsiDu[2]=v[127]-v[104]*v[63]+v[52]*(v[128]+v[130]+0.6599999999999999e-1*v[64])+v[68]*
 (0.32999999999999996e-1*(v[15]-v[18])+v[73]);
dPsidGradU[0][0]=0.32999999999999996e-1*v[7]+v[82];
dPsidGradU[0][1]=0.32999999999999996e-1*v[8]+v[84];
dPsidGradU[1][0]=v[82]+0.32999999999999996e-1*v[9];
dPsidGradU[1][1]=0.32999999999999996e-1*v[10]+v[84];
dPsidGradU[2][0]=0.32999999999999996e-1*v[11]+v[82];
dPsidGradU[2][1]=0.32999999999999996e-1*v[12]+v[84];
dPsiDu2[0][0]=v[115]+v[117]+v[126]+v[131]-0.264e0*v[50]*v[53]+0.132e0*v[56];
dPsiDu2[0][1]=v[113];
dPsiDu2[0][2]=v[106];
dPsiDu2[1][0]=v[113];
dPsiDu2[1][1]=v[111]-v[116]+v[117]+v[132]-0.264e0*v[51]*v[58]+0.132e0*v[61];
dPsiDu2[1][2]=v[107];
dPsiDu2[2][0]=v[106];
dPsiDu2[2][1]=v[107];
dPsiDu2[2][2]=v[104]+v[132]-0.264e0*v[52]*v[63]+0.132e0*v[64];
