...
void Step3<dim, n>::solve()
{
  ...
  SolverControl            solver_control(max_linear_iteration, linear_residual * system_rhs.l2_norm());
...
void Step3<dim, n>::make_timestep()
{
    ...
    catch (const std::exception &e)
    {
        ...
        std::cout << "[!] Redirecting to adaptive time-step reduction logic..." << std::endl;
        
        // Force the iteration count to max_it so that time_step_update() 
        // knows a failure occurred and cuts delta_t in half.
