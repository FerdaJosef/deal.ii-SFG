...
/******************* S U B R O U T I N E *********************/
void laplace-nonlinear(double v[130],double (*Uin),double (*Uold)
     ,double GradU[3],double (*dPsiDu),double dPsidGradU[3],double (*dPsiDu2)
     ,double dPsidGradU2[3][3],double dPsidUdGradU[3],double (*deltat),double (*time
     ))
{
int i01;
v[1]=(*Uin);
